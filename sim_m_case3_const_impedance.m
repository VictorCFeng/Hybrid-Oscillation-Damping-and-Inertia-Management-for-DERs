...
for k =1:9
    ...
    D_p_pu = d(k)*Sb*10/JDb;               % Active power damping before switching [pu]
...
%%
sim("simulation_model_constimpedance.slx",[0 60]);
save('case_5_const_impedance_simulation.mat','ScopeData')