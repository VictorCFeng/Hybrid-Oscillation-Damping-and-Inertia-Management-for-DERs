...
for k =1:9
    ...
    D_p_pu = d(k)*Sb*2/JDb;               % Active power damping before switching [pu]
...
for k=1:3
    ...
    d_gfl(k) = d(kk)*Sb*2;                                % active power damping [pu]
...
%%
sim("simulation_model_dynamic.slx",[0 60]);
save('case_5_dynamic_simulation.mat','ScopeData') 