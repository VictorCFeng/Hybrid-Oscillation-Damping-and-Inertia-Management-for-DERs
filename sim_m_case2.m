%% Robustness test with the solution of the robust problem
clear;clc;
%%
mpc = case_data;                       % load network data 
load case_2_data.mat                   % load M and D result
...
line = mpc.line*1.1;                   % Line parameter (nomial value)
...
for k=1:3
    ...
    m_gfl(k) = m(kk)*Sb;                                  % inertia [pu]
    d_gfl(k) = d(kk)*Sb;                                  % active power damping [pu]
...
save('case_2_simulation.mat','ScopeData')